...
public class SplitJoinStringsTest {
    ...
    public void whenJoiningTwoCollections_thenJoined() {
        ...
        assertEquals(result, Arrays.asList("Dog", "Cat", "Bird", "Cow", "Moose"));
    }
    ...
    public void whenConvertNestedCollectionToString_thenConverted() {
        ...
        String result = nested
                .stream()
                .map(nextList -> String.join("-", nextList))
                .collect(Collectors.joining("; "));
    ...
    public void whenSplitCollectionHalf_thenConverted() {
        ...
        assertEquals(result1, Arrays.asList("Dog", "Cat", "Cow"));
        assertEquals(result2, Arrays.asList("Bird", "Moose", "Pig"));
    }
    ...
    public void whenConvertStringToCollection_thenConverted() {
        ...
        assertEquals(result, Arrays.asList("Dog", "Cat", "Bird", "Cow"));
    }
    ...
    public void whenConvertStringToMap_thenConverted() {
        ...
        Map<Integer, String> result = Arrays
                .stream(animals.split(", "))
                .map(next -> next.split(" = "))
