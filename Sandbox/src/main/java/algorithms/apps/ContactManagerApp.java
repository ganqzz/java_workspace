package algorithms.apps;

import algorithms.ds.BasicBinaryTree;
...
public class ContactManagerApp {
    ...
    public void cleanupContacts() {
        ...
        contacts.delete(
                new Contact("Porsche", "Gadsden", null)); //delete a node with a right node only
        contacts.delete(
                new Contact("Annetta", "Coale", null)); //delete a node with a left node only
    ...
    private static class Contact implements Comparable<Contact> {
        ...
        public String toString() {
            return "Contact [firstName=" + firstName + ", lastName=" + lastName + ", phone=" +
                   phone + "]";
        }
    }
}
