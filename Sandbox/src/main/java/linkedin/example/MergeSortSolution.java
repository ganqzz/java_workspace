...
public class MergeSortSolution {
    ...
    private static class SequentialMergeSorter {

        private int[] array;

        SequentialMergeSorter(int[] array) {
            this.array = array;
        }
    ...
    private static class ParallelMergeSorter {

        private int[] array;

        ParallelMergeSorter(int[] array) {
            this.array = array;
        }
    ...
    public static void main(String[] args) {
        ...
        final int[] input = generateRandomArray(10_000_000);
