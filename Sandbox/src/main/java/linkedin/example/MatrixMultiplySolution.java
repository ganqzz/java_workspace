...
public class MatrixMultiplySolution {
    ...
    private static class SequentialMatrixMultiplier {
        ...
        SequentialMatrixMultiplier(int[][] A, int[][] B) {
            ...
            if (numColsA != numRowsB)
                throw new ArithmeticException(
                        String.format("Invalid dimensions; Cannot multiply %dx%d*%dx%d\n", numRowsA,
                                      numRowsB, numColsA, numColsB));
        }
    ...
    private static class ParallelMatrixMultiplier {
        ...
        private class ParallelWorker implements Callable<int[][]> {
            ...
            ParallelWorker(int rowStartC, int rowEndC) {
