...
public class ZipFileSystem {
    ...
    public static void main(String[] args) {
        ...
        try (FileSystem zipFs = openZip(Paths.get("temp/myData.zip"))) {
            copyToZip(zipFs);
    ...
    private static FileSystem openZip(Path zipPath) throws IOException, URISyntaxException {
        ...
        URI zipUri = new URI("jar:file", zipPath.toUri().getPath(), null); // Zip file system scheme
