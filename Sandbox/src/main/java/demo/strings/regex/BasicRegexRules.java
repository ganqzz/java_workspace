...
public class BasicRegexRules {
    ...
    public static void main(String[] args) {
        ...
        if (inPhone.matches(regexPhoneNumber)) {
            ...
            System.out.println("This number: " + inPhone
                               + " is not a valid phone number in format XXX-XXX-XXXX");
        }
        ...
        System.out
                .println("Please enter a new password, using exactly any 8 letters and numbers: ");
        ...
        String validCharactersRegex3 = "[0-9A-Za-z]{7}[^0-9A-Za-z]";
