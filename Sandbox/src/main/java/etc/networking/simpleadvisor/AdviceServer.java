...
public class AdviceServer implements Runnable {
    ...
    private void startServer() throws IOException {
        ...
        try {
            while (true) {
                ...
                AdviceServerForm.serverLogs
                        .append("New Client: " + (countClientConnections - 1) + " connected...\n");
     ...
     * @author Brian
     */
    private static class SomeServerImplementation implements Runnable {
        private Socket s;
        int counter;
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    AdviceServerForm.serverLogs.append("Input Received: " + input + "\n");
