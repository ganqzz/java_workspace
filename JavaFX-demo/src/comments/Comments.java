...
public class Comments extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        submit.addEventHandler(MouseEvent.MOUSE_ENTERED, e -> submit.setEffect(shadow));
        clear.addEventHandler(MouseEvent.MOUSE_ENTERED, e -> clear.setEffect(shadow));
        submit.addEventHandler(MouseEvent.MOUSE_EXITED, e -> submit.setEffect(null));
        clear.addEventHandler(MouseEvent.MOUSE_EXITED, e -> clear.setEffect(null));
