...
public class JpaPersistenceDemo {
    ...
    private static void retrieveDemo() {
        ...
        Bank bank = em.getReference(Bank.class, 1L); // lazy loading by proxy
    ...
    private static void retrieveDemo2() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("infinite-finances");
        EntityManager em = emf.createEntityManager();
        EntityTransaction tx = em.getTransaction();
        tx.begin();

        Bank bank = em.getReference(Bank.class, 123L); // lazy loading by proxy
        System.out.println(em.contains(bank));
        System.out.println(bank.getName()); // EntityNotFound
    ...
    private static void retrieveDemo3() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("infinite-finances");
        EntityManager em = emf.createEntityManager();
        EntityTransaction tx = em.getTransaction();
        tx.begin();

        Bank bank = em.find(Bank.class, 123L);
        System.out.println(em.contains(bank));
        System.out.println(bank.getName()); // NullPo
    ...
    private static void removeDemo2() {
        ...
        try {
            ...
            em.remove(bank2); // Managedである必要がある。
    ...
    private static void detachMergeDemo() {
        EntityManagerFactory emf = null;
        EntityManager em = null;
        EntityTransaction tx = null;
