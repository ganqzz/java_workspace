...
import hbdemo.entities.Bond;
import hbdemo.entities.Credential;
import hbdemo.entities.Stock;
import hbdemo.entities.Transaction;
import hbdemo.entities.User;
import hbdemo.entities.UserCredentialView;
...
public class ViewDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            UserCredentialView view = session.get(UserCredentialView.class, 1L);
