...
--
-- Host: localhost    Database: ifinances
-- ------------------------------------------------------
...
INSERT INTO `account` VALUES (1,1,'CHECKING','Checking Account',1000.00,1000.00,'2014-12-04','2014-12-04','Kevin Bowersox','2014-12-04 17:30:30','Kevin Bowersox','2014-12-04 17:30:30'),(2,2,'CHECKING','Interest Checking Account',1000.00,1000.00,'2014-12-04','2014-12-04','Kevin Bowersox','2014-12-04 17:30:30','Kevin Bowersox','2014-12-04 17:30:30'),(3,NULL,'SAVINGS','Savings Account',50.00,100.00,'2017-06-05','2017-06-05','Kevin Bowersox','2017-06-05 21:09:09','Kevin Bowersox','2017-06-05 21:09:09');
...
INSERT INTO `account_type` VALUES (1,'Checking','2017-05-30','kevinbowersox','2017-05-30','kevinbowersox'),(2,'Checking','2017-05-30','kevinbowersox','2017-05-30','kevinbowersox'),(3,'Savings','2017-05-30','mk','2017-05-30','mk'),(4,'Savings','2017-05-30','mk','2017-05-30','mk');
...
--
-- Table structure for table `bank_contact_list`
--

DROP TABLE IF EXISTS `bank_contact_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bank_contact_list` (
  `BANK_ID` bigint NOT NULL,
  `NAME` varchar(100) NOT NULL,
  PRIMARY KEY (`BANK_ID`,`NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `bank_contact_list`
--

LOCK TABLES `bank_contact_list` WRITE;
/*!40000 ALTER TABLE `bank_contact_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `bank_contact_list` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `bond` VALUES (53,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 22:02:26',10.22,123.22,'2017-06-04 00:00:00',16),(103,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 22:04:48',10.22,123.22,'2017-06-04 00:00:00',17),(153,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 22:17:53',10.22,123.22,'2017-06-04 00:00:00',18),(203,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 22:50:05',10.22,123.22,'2017-06-04 00:00:00',20),(253,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 23:12:51',10.22,123.22,'2017-06-04 00:00:00',22),(1451,'Long Term Bond Purchases','JP Morgan Chase','2014-12-05 15:40:08',10.22,123.22,'2014-12-05 00:00:00',2),(1452,'Long Term Bond Purchases','JP Morgan Chase','2014-12-13 16:45:53',10.22,123.22,'2014-12-13 00:00:00',NULL),(1453,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 19:14:09',10.22,123.22,'2017-06-04 00:00:00',NULL),(1454,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 19:23:44',10.22,123.22,'2017-06-04 00:00:00',NULL),(1455,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 19:51:30',10.22,123.22,'2017-06-04 00:00:00',NULL),(1456,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 21:30:18',10.22,123.22,'2017-06-04 00:00:00',NULL),(1457,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 22:01:13',10.22,123.22,'2017-06-04 00:00:00',NULL);
/*!40000 ALTER TABLE `bond` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bond_mapped`
--

DROP TABLE IF EXISTS `bond_mapped`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bond_mapped` (
  `INVESTMENT_ID` bigint NOT NULL AUTO_INCREMENT,
  `NAME` varchar(100) NOT NULL,
  `ISSUER` varchar(100) NOT NULL,
  `PURCHASE_DATE` datetime NOT NULL,
...
--
-- Dumping data for table `bond_mapped`
--

LOCK TABLES `bond_mapped` WRITE;
/*!40000 ALTER TABLE `bond_mapped` DISABLE KEYS */;
INSERT INTO `bond_mapped` VALUES (1,'Long Term Bond Purchases','JP Morgan Chase','2017-06-04 23:12:28',10.22,123.22,'2017-06-04 00:00:00');
/*!40000 ALTER TABLE `bond_mapped` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `credential` VALUES (1,2,'kmb385','kevinspassword');
...
INSERT INTO `finances_user` VALUES (1,'kevin','bowersox','2017-06-05','kmb3','kmb','2017-06-05 21:25:13','Kevin','2017-06-05 21:25:13','line 1','line2','Philadelphia','PA','12345',NULL),(2,'Kevin','Bowersox','2017-06-05','kevin.bowersox@navy.mil','Kevin Bowersox','2017-06-05 21:27:08','Kevin Bowersox','2017-06-05 21:27:08',NULL,NULL,NULL,NULL,NULL,NULL),(3,'John','Doe','2017-06-06','test@test.com','system','2017-06-06 09:37:34','Kevin Bowersox','2017-06-06 09:37:34',NULL,NULL,NULL,NULL,NULL,NULL);
...
--
-- Table structure for table `investment_table_per_class`
--

DROP TABLE IF EXISTS `investment_table_per_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `investment_table_per_class` (
  `INVESTMENT_ID` bigint NOT NULL AUTO_INCREMENT,
  `PORTFOLIO_ID` bigint DEFAULT NULL,
  `NAME` varchar(100) DEFAULT NULL,
  `ISSUER` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `investment_table_per_class`
--

LOCK TABLES `investment_table_per_class` WRITE;
/*!40000 ALTER TABLE `investment_table_per_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `investment_table_per_class` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `portfolio` VALUES (1,'First Investments'),(2,'First Investments'),(6,'First Investments'),(7,'First Investments'),(8,'First Investments'),(9,'First Investments'),(10,'First Investments'),(12,'First Investments'),(16,'First Investments'),(17,'First Investments'),(18,'First Investments'),(19,'First Investments'),(20,'First Investments'),(21,'First Investments'),(22,'First Investments'),(23,'First Investments');
...
INSERT INTO `stock` VALUES (52,'Private American Stock Purchases','Allen Edmonds','2017-06-04 22:02:26',100.00,1922,16),(102,'Private American Stock Purchases','Allen Edmonds','2017-06-04 22:04:48',100.00,1922,17),(152,'Private American Stock Purchases','Allen Edmonds','2017-06-04 22:17:53',100.00,1922,18),(202,'Private American Stock Purchases','Allen Edmonds','2017-06-04 22:50:05',100.00,1922,20),(252,'Private American Stock Purchases','Allen Edmonds','2017-06-04 23:12:51',100.00,1922,22),(1450,'Private American Stock Purchases','Allen Edmonds','2014-12-05 15:40:08',100.00,1922,2),(1451,'Private American Stock Purchases','Allen Edmonds','2014-12-13 16:45:53',100.00,1922,NULL),(1452,'Private American Stock Purchases','Allen Edmonds','2017-06-04 19:14:09',100.00,1922,NULL),(1453,'Private American Stock Purchases','Allen Edmonds','2017-06-04 19:23:44',100.00,1922,NULL),(1454,'Private American Stock Purchases','Allen Edmonds','2017-06-04 19:51:30',100.00,1922,NULL),(1455,'Private American Stock Purchases','Allen Edmonds','2017-06-04 21:30:18',100.00,1922,NULL),(1456,'Private American Stock Purchases','Allen Edmonds','2017-06-04 22:01:12',100.00,1922,NULL);
/*!40000 ALTER TABLE `stock` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `stock_mapped`
--

DROP TABLE IF EXISTS `stock_mapped`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_mapped` (
  `INVESTMENT_ID` bigint NOT NULL AUTO_INCREMENT,
  `NAME` varchar(100) NOT NULL,
  `ISSUER` varchar(45) NOT NULL,
  `PURCHASE_DATE` datetime NOT NULL,
...
--
-- Dumping data for table `stock_mapped`
--

LOCK TABLES `stock_mapped` WRITE;
/*!40000 ALTER TABLE `stock_mapped` DISABLE KEYS */;
INSERT INTO `stock_mapped` VALUES (1,'Private American Stock Purchases','Allen Edmonds','2017-06-04 23:12:28',100.00,1922);
/*!40000 ALTER TABLE `stock_mapped` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `time_test` (
  `TIME_TEST_ID` bigint NOT NULL AUTO_INCREMENT,
...
INSERT INTO `transaction` VALUES (1,1,'Withdrawl','Dress Belt',50.00,1000.00,950.00,'New Dress Belt','Kevin Bowersox','2014-12-06 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(2,1,'Withdrawl','Work Shoes',100.00,950.00,850.00,'Nice Pair of Shoes','Kevin Bowersox','2014-12-07 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(3,1,'Withdrawl','Shirt',100.00,850.00,750.00,'Nice Shirt','Kevin Bowersox','2014-12-08 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(4,1,'Withdrawl','Socks',10.00,750.00,740.00,'Nice Socks','Kevin Bowersox','2014-12-09 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(5,1,'Withdrawl','Tie',40.00,740.00,700.00,'Nice Tie','Kevin Bowersox','2014-12-09 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(6,1,'Withdrawl','Pants',100.00,700.00,600.00,'Nice Pants','Kevin Bowersox','2014-12-10 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(7,1,'Withdrawl','Lunch',20.00,600.00,580.00,'Nice Lunch','Kevin Bowersox','2014-12-11 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(8,1,'Withdrawl','Dinner',30.00,580.00,550.00,'Great Dinner','Kevin Bowersox','2014-12-11 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(9,1,'Withdrawl','Breakfast',10.00,550.00,540.00,'Breakfast at Tiffanys','Kevin Bowersox','2014-12-12 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(10,1,'Withdrawl','Groceries',100.00,540.00,440.00,'Healthy Food','Kevin Bowersox','2014-12-13 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(11,1,'Deposit','Pay Check',1000.00,440.00,1440.00,'Pay Day','Kevin Bowersox','2014-12-14 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(12,1,'Deposit','Bonus',500.00,1440.00,1940.00,'Annual Bonus','Kevin Bowersox','2014-12-19 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(13,2,'Withdrawl','Work Shoes',100.00,950.00,850.00,'Nice Pair of Shoes','Kevin Bowersox','2014-12-07 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(14,2,'Withdrawl','Shirt',100.00,850.00,750.00,'Nice Shirt','Kevin Bowersox','2014-12-08 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(15,2,'Withdrawl','Socks',10.00,750.00,740.00,'Nice Socks','Kevin Bowersox','2014-12-09 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(16,2,'Withdrawl','Tie',40.00,740.00,700.00,'Nice Tie','Kevin Bowersox','2014-12-09 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(17,2,'Withdrawl','Pants',100.00,700.00,600.00,'Nice Pants','Kevin Bowersox','2014-12-10 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(18,2,'Withdrawl','Lunch',20.00,600.00,580.00,'Nice Lunch','Kevin Bowersox','2014-12-11 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(19,2,'Withdrawl','Dinner',30.00,580.00,550.00,'Great Dinner','Kevin Bowersox','2014-12-11 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(20,2,'Withdrawl','Breakfast',10.00,550.00,540.00,'Breakfast at Tiffanys','Kevin Bowersox','2014-12-12 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(21,2,'Withdrawl','Groceries',100.00,540.00,440.00,'Healthy Food','Kevin Bowersox','2014-12-13 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(22,2,'Deposit','Royalties',1000.00,440.00,1440.00,'Pay Day','Kevin Bowersox','2014-12-14 10:53:30','Kevin Bowersox','2014-12-06 10:53:30'),(23,2,'Deposit','Bonus',20000.00,1440.00,21440.00,'Annual Bonus','Kevin Bowersox','2014-12-19 10:53:30','Kevin Bowersox','2014-12-06 10:53:30');
...
INSERT INTO `user_address` VALUES (3,'101 Address Line','102 Address Line','New York','PA','10000','PRIMARY');
...
/*!50013 DEFINER=`ganq`@`%` SQL SECURITY INVOKER */
...
-- Dump completed on 2020-05-03 11:39:52
