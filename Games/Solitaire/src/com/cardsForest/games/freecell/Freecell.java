package com.cardsForest.games.freecell;

import com.cardsForest.foundations.Face.Rank;
import com.cardsForest.foundations.Stack;
import com.cardsForest.games.klondike.FoundationBehavior;
import com.cardsForest.games.klondike.StockBehavior;
import com.cardsForest.games.klondike.TableauBehavior;
import com.cardsForest.games.klondike.WasteBehavior;
 ...
 *
 */
public class Freecell extends GameLogic {
    ...
    public void deal() {
        ...
        for (int i = 0; i < 7; i++) {
            stock.moveTo(stacks.get(6 + i), 1, true); // no animation
            stacks.get(6 + i).flipTop();
            for (int j = i + 1; j < 7; j++) {
                stock.moveTo(stacks.get(6 + j), 1, true); // no animation
            }
        }
    }
