...
public class StackSprite {
    ...
    /**
     * relative position of the stack
     * <p>
    ...
    /**
     * absolute position of the stack (in pixels)
     * <p>
     * (0,0) is top-left corner,
     * (display width, display height) is bottom-right corner
     * <p>
    ...
    public void draw(Graphics g, boolean useSelected) {
        if (!useSelected) {
            ...
            g.fillRect(x, y, CardSpriteStore.getWidth(), CardSpriteStore.getHeight());
        }
        ...
        if (spread) {
            ...
            if (topCard.isFaceUp()) {
                ...
                sprite = CardSpriteStore.getSprite(topCard.getFace());
            } else {
                //take the back sprite
                sprite = CardSpriteStore.getBack();
            }
    ...
    public void translateTo(StackSprite other, int index) {
        ...
        x = other.x;
        y = (other.spread) ? (other.y + SPREAD_STEP * index) : other.y;
    ...
    public Point getCardPos(int index) {
        Point p = new Point();
        p.x = x;
        p.y = (spread) ? (y + SPREAD_STEP * index) : y;
        return p;
    }
