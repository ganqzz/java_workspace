...
import static com.cardsForest.foundations.Face.Suit.CLUBS;
import static com.cardsForest.foundations.Face.Suit.DIAMONDS;
import static com.cardsForest.foundations.Face.Suit.HEARTS;
import static com.cardsForest.foundations.Face.Suit.SPADES;

/**
 * Contains constants for all possible faces of a card
 * <p>
 * <b>important ! </b> <br>
 * do not change the name and order of those constants without reviewing uses of methods name() and
 * ordinal() by other classes
 */
public enum Face {
     ...
     */
    private static Map<Suit, Map<Rank, Face>> table = new EnumMap<Suit, Map<Rank, Face>>(
            Suit.class);
