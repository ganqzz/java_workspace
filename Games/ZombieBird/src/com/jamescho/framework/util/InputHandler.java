...
public class InputHandler implements KeyListener, MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
        currentState.onMousePress((int) (e.getX() / (float) GameMain.GAME_SCALE),
                                  (int) (e.getY() / (float) GameMain.GAME_SCALE));
    }

    @Override
    public void mouseReleased(MouseEvent e) {
        currentState.onMouseRelease((int) (e.getX() / (float) GameMain.GAME_SCALE),
                                    (int) (e.getY() / (float) GameMain.GAME_SCALE));
    }
