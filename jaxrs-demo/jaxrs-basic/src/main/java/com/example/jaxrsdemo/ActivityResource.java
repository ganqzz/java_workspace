...
import com.example.jaxrsdemo.model.User;
import com.example.jaxrsdemo.repository.ActivityRepository;
import com.example.jaxrsdemo.repository.ActivityRepositoryStub;
...
public class ActivityResource {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public Activity createActivity(Activity activity) { // Unmarshall
